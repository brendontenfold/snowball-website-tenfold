  ...
  return (
    <PageTransition>
      ...
      {hasVideo && (
        <Jumbotron className='full-width-image-container d-flex justify-content-center align-items-center flex-column text-right'>
          ...
          <div className='text-center mb-5 pb-5'>
            <h1 className='big-text' id='mainHeading'>
              {mainText}
            </h1>
            <h3
              className='big-subtitle subtitle-text-align text-primary sub-text custom-size'
              id='mainSubheading'
            >
              {subText}
            </h3>
      ...
      >
        ...
        <Container fluid className='second-section'>
          <Row className='justify-content-center h-100'>
            <Col md={5} lg={3} className='left-text-col'>
              <Fade bottom>
                <h1 className='text-primary display-2 mb-3'>
            ...
            <Col md={6} xs={12} style={{ backgroundColor: '#006fbb' }}>
              ...
              <Controller>
                {stockSection.stocks.map((stock, key) => {
                  ...
                  let stockClassName =
                    'd-flex flex-column justify-content-center stock-detail';
              ...
              <Controller>
                {featureSection.sections.map((section, ndx) => (
                  <Scene
                    ...
                    pin
                    triggerHook={0}
                    key={`featureSection-sections-${ndx}`}
                  >
                    <div
        ...
        <div
          className='carousel slide feature-carousel-container container'
          data-ride='carousel'
        >
          ...
          <div className='container'>
            <div className='row justify-content-around align-items-center h-100'>
              <Col md={5} lg={4} className='ml-auto'>
                <Fade bottom>
                  <h1 className='text-primary display-2 mb-3'>
                    {realTimeStockSection.mainText}
                  </h1>
                  <p className='font-size-18 dark-grey'>
                    {realTimeStockSection.description}
                  </p>
              ...
              <Col md={6} lg={6} className='mr-auto'>
                <Fade bottom cascade>
                  <Row noGutters>
                    <LiveStockCarousel
                      stocks={realTimeStockSection.stockList}
                    />
                  </Row>
                </Fade>
              </Col>
...
class IndexPage extends React.Component {
  ...
  componentDidMount() {
    if (document.fonts.status === 'loading') {
      ...
      document.fonts.onloadingdone = () => this.showSite();
    } else {
      this.showSite();
    }
  ...
  shouldUseWhiteLogo = () =>
    !(this.state.geoCountry === 'New Zealand' || 'Not specified');

  render() {
    const { frontmatter } = this.props.data.markdownRemark;
    const { loadingDone, fading } = this.state;
    ...
    return (
      <>
        ...
        <Layout
          white={this.shouldUseWhiteLogo()}
          stickyFooter
          footerLinks={frontmatter.footerLinks}
        >
